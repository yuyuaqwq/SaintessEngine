...
from ext_world.space import MESH, Space, register_topology, topology_names   # noqa: E402
...
def t8_zero_knowledge():
    ...
    bad = []
    for root, _dirs, files in os.walk(os.path.join(ROOT, "extends", "ext_world", "space")):
        for fn in files:
