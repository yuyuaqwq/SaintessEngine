...
四件东西::
    ...
    from ext_loot.loot import pick_weighted, pick_many, roll_range, draw_slots, count_for
...
from .pool import (STRATEGIES, LootTable, SimpleCtx, UnknownStrategy, get_strategy,
                   register_strategy,
...
__all__ = [
    ...
    "strategy_spec", "STRATEGIES", "UnknownStrategy",
    # 档位 / 挂载
