...
--------------------------------------
  ...
  ⑥ 零知识：`extends/ext_economy/trade/` 源码 grep 不到具体游戏词汇（原文扫描）
...
from ext_economy.trade import apply_rate                                     # noqa: E402
...
# ════════════════════════════════════════════════════════ ⑦ 突变反证
_SRC = os.path.join(ROOT, "extends", "ext_economy", "trade", "__init__.py")
...
def _load_mutated(edits):
    ...
    ns = {"__name__": "ext_economy.trade._mutant", "__file__": _SRC}
