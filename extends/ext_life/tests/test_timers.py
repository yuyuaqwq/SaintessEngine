...
import ext_life.timers as TIMERS_MOD                                       # noqa: E402
from ext_life.timers import TimerStorageError, Timers                      # noqa: E402

MODULE_PATH = os.path.join(ROOT, "extends", "ext_life", "timers", "__init__.py")
...
def t7_zero_knowledge():
    ...
    bad, n = [], 0
    for dirpath, _dirs, files in os.walk(os.path.join(ROOT, "extends", "ext_life", "timers")):
