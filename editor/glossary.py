...
_EFFECT_RULES = {
    ...
    "debuff_scale": {"zh": "每层受击增伤", "note": "⚠ **当前无消费者**：写了不生效。要「每层承伤 +N%」请用 taken_calc 乘区。",
    ...
    "period.dmg_type": {"zh": "周期伤害类型", "note": "⚠ **当前无消费者**：DOT 落地统一调 deal_damage 不传 dmg_kind → 吃不到类型免伤/格挡，不是因为写了真伤。",
