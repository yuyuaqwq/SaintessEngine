...
from saintess_engine.trade import (DailyLimit, DailyLimitExceeded, SaleResult,   # noqa: E402
...
def _load_mutated(edits):
    ...
    path = os.path.join(ROOT, "saintess_engine", "trade", "__init__.py")
    with open(path, encoding="utf-8") as fh:
        src = fh.read()
    ...
    ns = {"__name__": "saintess_engine.trade._mutant", "__file__": path}
